...
export async function PUT(req: Request, { params }: { params: { id:string }}){
  ...
  const patch:any = { nome: b.nome, cognome: b.cognome, telefono: b.telefono, email: b.email,
    genitore_nome: b.genitoreNome, genitore_telefono: b.genitoreTelefono, grado: b.grado, fita_numero: b.fitaNumero,
