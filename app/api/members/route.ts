...
export async function POST(req: Request){
  ...
  const { data, error } = await supabase.from('members').insert({
    nome: b.nome, cognome: b.cognome, sede: sedeId, telefono: b.telefono, email: b.email,
    genitore_nome: b.genitoreNome, genitore_telefono: b.genitoreTelefono, grado: b.grado || 'Bianca',
